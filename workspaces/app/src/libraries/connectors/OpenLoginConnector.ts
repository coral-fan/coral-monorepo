...
import { OPEN_LOGIN_CLIENT_ID } from './consts';
...
const OPEN_LOGIN_PROVIDER_ERROR_MESSAGE = new Error('OpenLogin connector not activated yet.');
...
export class OpenLoginConnector extends AbstractConnector {
  ...
  async getProvider(): Promise<Provider> {
    if (!this.wallet) {
      throw OPEN_LOGIN_PROVIDER_ERROR_MESSAGE;
    }
