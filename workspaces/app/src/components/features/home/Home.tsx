          ...
          <ul className="mb-20 lg:mb-4 flex space-x-2.5">
            <li>
              <a
                ...
                className="bg-gray-2 bg-opacity-20 rounded-full hover:bg-opacity-50 duration-300 w-9 h-9 lg:w-11 lg:h-11 flex items-center justify-center duration-300"
            ...
            <div className="group w-full sm:mt-auto flex items-start justify-between bg-orange-1 rounded-1 py-4 px-5 mb-5 relative hover:bg-gray-2 duration-300">
              ...
              <div className="flex flex-col items-start w-3/4">
                ...
                <p className="text-lg leading-lh-3 xl:text-2xl xl:leading-7 text-gray-1">
                  Sign up with MetaMask or an existing <br className="hidden lg:block"></br>social
                  account
                </p>
              </div>
          ...
          <div className="col-span-12 sm:col-span-6 flex flex-col items-start duration-300">
            ...
            {!isAuthenticated && (
              <button
                onClick={openModal}
                disabled={isAuthenticated}
                className="inline-flex text-xs leading-3 tracking-1 uppercase text-gray-1 py-2 px-2.5 bg-orange-1 rounded-full duration-300"
              >
                SIGN UP
              </button>
            )}
