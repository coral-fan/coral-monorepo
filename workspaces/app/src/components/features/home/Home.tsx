...
export const Home = () => {
  ...
  return (
    <div className="-mt-m-4 s-2:-mt-m-3">
      <section className="grid grid-cols-12 gap-4 lg:gap-5 mb-20 md:mb-24 xl:mb-32 relative duration-300">
        <div className="col-span-12 lg:col-span-6 mb-2.5 sm:mb-0 relative">
          <div className="overflow-hidden duration-300 -mx-6 lg:mx-0">
            <img
              className="w-full"
          ...
          {!isAuthenticated &&
            <div className="group w-full sm:mt-auto flex items-start justify-between bg-orange-1 rounded-1 py-4 px-5 mb-5 relative hover:bg-gray-2 duration-300">
              ...
              <div className="flex flex-col items-start w-3/4">
                <h3 className="text-lg leading-lh-3 xl:text-1 lg:leading-none tracking-3 uppercase text-gray-1 font-medium mb-4 xl:mb-6">
                  Create an account
                </h3>
                <p className="text-lg leading-lh-3 xl:text-2xl xl:leading-7 text-gray-1">
                  Sign up with MetaMask or an existing <br className="hidden lg:block"></br>social account
                </p>
              </div>
      ...
      <section className="mb-20 lg:mb-24 xl:mb-32 relative">
        <h3 className="text-lg leading-lh-3 xl:text-1 xl:leading-none font-medium tracking-4 uppercase mb-3.5">Upcoming drop</h3>
        ...
        <div className="grid grid-cols-12 gap-4 lg:gap-5">
          <div className="col-span-12 sm:col-span-6">
            ...
            <div className="flex space-x-4 lg:space-x-5 text-xs leading-lh-1 tracking-1 uppercase mb-10 lg:mb-24">
              <div>Drops on</div>
              <time className="inline-block" dateTime="2022-06-16">
                June 16, 2022
              </time>
            </div>
            <div className="rounded-1 overflow-hidden sm:hidden mb-5">
              <img
                className="w-full"
            ...
            <p className="text-lg leading-lh-3 xl:text-1 xl:leading-none font-medium tracking-4 max-w-xl mb-5">
              Introducing the Brockton collective of rappers, fashion designers, artists, and creatives. This NFT will grant you access to a live performance, exclusive merch, and a spot in the growing community.
            </p>
            {/* ADD VB LINK HERE */}
      ...
      <section className="mb-20 lg:mb-24 xl:mb-32">
        ...
        <div className="grid grid-cols-12 gap-4 lg:gap-5 group relative">
          ...
          <div className="col-span-12 sm:col-span-6 flex flex-col items-start duration-300">
            ...
            <p className="text-lg leading-lh-3 xl:text-1 xl:leading-none font-medium tracking-4 max-w-xl mb-5">
              You don’t need an existing crypto wallet to sign up. Connect your MetaMask account or sign up with an exsiting social account. 
            </p>
            {!isAuthenticated &&
              <button onClick={handleOpenSignUpModal} disabled={isAuthenticated} className="inline-flex text-xs leading-3 tracking-1 uppercase text-gray-1 py-2 px-2.5 bg-orange-1 rounded-full duration-300">
                SIGN UP
              </button>
            }
              ...
              <div className="border-t border-gray-2 border-opacity-20 pt-3.5 grid grid-cols-10 lg:grid-cols-12 gap-5">
                ...
                <div className="col-span-8 lg:col-span-10 grid grid-cols-1 lg:grid-cols-10 gap-2.5 lg:gap-5">
                  ...
                  <p className="lg:col-span-6 text-base leading-5 lg:text-lg lg:leading-lh-3 tracking-2">
                    Connect your existiing MetaMask wallet. You will be automatically connected to the correct network. 
                  </p>
                </div>
              </div>
              <div className="border-t border-gray-2 border-opacity-20 pt-3.5 grid grid-cols-10 lg:grid-cols-12 gap-5">
                ...
                <div className="col-span-8 lg:col-span-10 grid grid-cols-1 lg:grid-cols-10 gap-2.5 lg:gap-5">
                  ...
                  <p className="lg:col-span-6 text-base leading-5 lg:text-lg lg:leading-lh-3 tracking-2">
                    Sign up with Gmail, Twitter, Discord, Apple, Twitch, or Facebook. We will create a wallet you control for you. 
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-12 gap-4 lg:gap-5 relative">
          <div className="col-span-12 sm:col-span-6 flex flex-col items-start">
            ...
            <p className="text-lg leading-lh-3 xl:text-1 xl:leading-none font-medium tracking-4 max-w-xl mb-10 lg:mb-24">
              Coral enables everything you expect with the benefits of crypto, NFTs, exclusive experiences, and a chance to your for your fandom. 
            </p>
            <div className="grid grid-cols-1 gap-10 lg:gap-20">
              <div className="border-t border-gray-2 border-opacity-20 pt-3.5 grid grid-cols-10 lg:grid-cols-12 gap-5">
                ...
                <div className="col-span-8 lg:col-span-10 grid grid-cols-1 lg:grid-cols-10 gap-2.5 lg:gap-5">
                  ...
                  <p className="lg:col-span-6 text-base leading-5 lg:text-lg lg:leading-lh-3 tracking-2">
                    Music, collectibles, events, merch, and more infused with benefits of Web3 to reward fans and return value to artists.
                  </p>
                </div>
              </div>
              <div className="border-t border-gray-2 border-opacity-20 pt-3.5 grid grid-cols-10 lg:grid-cols-12 gap-5">
                ...
                <div className="col-span-8 lg:col-span-10 grid grid-cols-1 lg:grid-cols-10 gap-2.5 lg:gap-5">
                  ...
                  <p className="lg:col-span-6 text-base leading-5 lg:text-lg lg:leading-lh-3 tracking-2">
                    NFTs as rare digital collectibles, tickets, and membership passes to exclusive content, discounts and more.
                  </p>
                </div>
              </div>
              <div className="border-t border-gray-2 border-opacity-20 pt-3.5 grid grid-cols-10 lg:grid-cols-12 gap-5">
                ...
                <div className="col-span-8 lg:col-span-10 grid grid-cols-1 lg:grid-cols-10 gap-2.5 lg:gap-5">
                  ...
                  <p className="lg:col-span-6 text-base leading-5 lg:text-lg lg:leading-lh-3 tracking-2">
                    Exclusive events, live performances, and unique experiences that celebrate the connective power of music.
                  </p>
                </div>
              </div>
              <div className="border-t border-gray-2 border-opacity-20 pt-3.5 grid grid-cols-10 lg:grid-cols-12 gap-5">
                ...
                <div className="col-span-8 lg:col-span-10 grid grid-cols-1 lg:grid-cols-10 gap-2.5 lg:gap-5">
                  ...
                  <p className="lg:col-span-6 text-base leading-5 lg:text-lg lg:leading-lh-3 tracking-2">
                    Fans take an active role in artist communities through rewards, shared success and the love of the music.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="mb-20 lg:mb-24 xl:mb-32">
        <h3 className="text-lg leading-lh-3 xl:text-1 xl:leading-none font-medium tracking-4 uppercase mb-3.5">Coral Editorial</h3>
        <div className="grid md:grid-cols-2 gap-4 lg:gap-5">
          <article className="post tag-hash-highlight tag-news featured grid grid-cols-12 gap-x-4 lg:gap-x-5 border-t border-gray-2 border-opacity-20 pt-4 lg:pt-5 group relative duration-300" data-id="628cdebc957828003dbaf71f">
            <div className="col-span-6 relative">
              <div className="rounded-1 group-hover:rounded-2 overflow-hidden duration-300">
                <img className="w-full" src="https://editorial.coral.fan/content/images/size/w335h335/2022/05/Coral-Editorial-Header-Genre-Intro-3.jpg" alt="Creating Musical Connections in a Post-Pandemic World"></img>
              </div>
            </div>
            <div className="col-span-6 group-hover:opacity-60 duration-300">
              <h3>
                <a href="https://editorial.coral.fan/creating-musical-connections-in-a-post-pandemic-world/" className="text-lg leading-none lg:text-1 lg:leading-none tracking-2 mb-3 font-medium duration-300 inline-block">Creating Musical Connections in a Post-Pandemic World</a>
              </h3>
              <div className=" flex space-x-4 lg:space-x-5">
                <time className="inline-block text-xs leading-lh-1 tracking-1 uppercase text-gray-2" dateTime="2022-05-26">26 May 2022</time>
              </div>
            </div>
            <a href="https://editorial.coral.fan/creating-musical-connections-in-a-post-pandemic-world/" className="absolute top-0 left-0 w-full h-full"></a>
          </article>
          <article className="post tag-news featured grid grid-cols-12 gap-x-4 lg:gap-x-5 border-t border-gray-2 border-opacity-20 pt-4 lg:pt-5 group relative duration-300" data-id="6286e0d97d4697004d14b868">
            <div className="col-span-6 relative">
              <div className="rounded-1 group-hover:rounded-2 overflow-hidden duration-300">
                <img className="w-full" src="https://editorial.coral.fan/content/images/size/w335h335/2022/05/Group-1202--1-.jpg" alt="Symbiosis in Music"></img>
              </div>
            </div>
            <div className="col-span-6 group-hover:opacity-60 duration-300">
              <h3>
                <a href="https://editorial.coral.fan/symbiosis-in-music/" className="text-lg leading-none lg:text-1 lg:leading-none tracking-2 mb-3 font-medium duration-300 inline-block">Symbiosis in Music</a>
              </h3>
              <div className=" flex space-x-4 lg:space-x-5">
                <a href="/tag/news/" className="inline-block text-xs leading-lh-1 tracking-1 uppercase text-gray-2">News</a>
                <time className="inline-block text-xs leading-lh-1 tracking-1 uppercase text-gray-2" dateTime="2022-05-19">19 May 2022</time>
              </div>
            </div>
            <a href="https://editorial.coral.fan/symbiosis-in-music/" className="absolute top-0 left-0 w-full h-full"></a>
          </article>
        </div>
      </section>
        ...
        <div className="grid grid-cols-12 gap-4 lg:gap-5 relative">
          <div className="col-span-12 sm:col-span-6 flex flex-col items-start">
            ...
            <p className="text-lg leading-lh-3 xl:text-1 xl:leading-none font-medium tracking-4">
              Coral connects artists and fans through direct support, shared success, and direct payments that reduce fees.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-10 lg:gap-20">
                ...
                <div className="col-span-8 lg:col-span-10 grid grid-cols-1 lg:grid-cols-10 gap-2.5 lg:gap-5">
                  ...
                  <div className="lg:col-span-6">
                    <p className="text-base leading-5 lg:text-lg lg:leading-lh-3 tracking-2 mb-3">
                      Artist-first fee structures return more money to the artists and fans. With Coral and crypto payments, roughly 90% of money goes directly to artists.
                    </p>
                  </div>
                </div>
              </div>
              <div className="border-t border-gray-2 border-opacity-20 pt-3.5 grid grid-cols-10 lg:grid-cols-12 gap-5">
                ...
                <div className="col-span-8 lg:col-span-10 grid grid-cols-1 lg:grid-cols-10 gap-2.5 lg:gap-5">
                  ...
                  <p className="lg:col-span-6 text-base leading-5 lg:text-lg lg:leading-lh-3 tracking-2">
                    Traditional credit card payments or crypto for instant, global, direct transactions that cut out middlemen and reduce fees.
                  </p>
                </div>
              </div>
              <div className="border-t border-gray-2 border-opacity-20 pt-3.5 grid grid-cols-10 lg:grid-cols-12 gap-5">
                ...
                <div className="col-span-8 lg:col-span-10 grid grid-cols-1 lg:grid-cols-10 gap-2.5 lg:gap-5">
                  ...
                  <p className="lg:col-span-6 text-base leading-5 lg:text-lg lg:leading-lh-3 tracking-2">
                    NFTs serve as tickets, and membership passes that can be held and used for perks or resold to other fans.
                  </p>
                </div>
              </div>
              <div className="border-t border-gray-2 border-opacity-20 pt-3.5 grid grid-cols-10 lg:grid-cols-12 gap-5">
                ...
                <div className="col-span-8 lg:col-span-10 grid grid-cols-1 lg:grid-cols-10 gap-2.5 lg:gap-5">
                  ...
                  <div className="lg:col-span-6">
                    <p className="text-base leading-5 lg:text-lg lg:leading-lh-3 tracking-2 mb-3">
                      Coral uses the Avalanche blockchain to facilitate transacting in open marketplaces like never before.
                    </p>
                    <a
            ...
            <div className="group lg:min-h-min-h-1 flex bg-orange-1 rounded-1 py-4 px-5 relative hover:bg-gray-2 duration-300">
              ...
              <div className="flex flex-col items-start lg:w-11/12">
                ...
                <p className="text-lg leading-lh-3 lg:text-2xl lg:leading-7 text-gray-1">
                  Coral is coming soon with exclusive events, experiences, and more. Sign up to reserve your spot.
                </p>
              </div>
            </div>
          ) : (
