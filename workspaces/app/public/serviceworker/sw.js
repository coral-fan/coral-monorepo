                ...
                <html lang="en">
                  ...
                  <body>
                    <div id="message" class="container">
                      ...
                      <h1 class="title content" id="closeText" style="display: none;">
                    ...
                    <script>
                      ...
                      var instanceParams = {};
                      var preopenInstanceId = new URL(window.location.href).searchParams.get(
                        'preopenInstanceId'
                      );
                          ...
                          try {
                            if (Object.keys(hashParams).length > 0 && hashParams.state) {
                              instanceParams =
                                JSON.parse(
                                  window.atob(
                                    decodeURIComponent(decodeURIComponent(hashParams.state))
                                  )
                                ) || {};
